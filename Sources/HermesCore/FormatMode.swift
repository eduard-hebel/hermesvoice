...
enum FormatMode: String, CaseIterable, Identifiable, Codable {
    ...
    var label: String {
        switch self {
        case .free:         "Raw"
        case .shortMessage: "Short Message"
        case .mail:         "Email"
        case .note:         "Note"
    ...
    var cleanupInstruction: String {
        ...
        case .shortMessage:
            return """
            Stil: Formuliere als kurze Nachricht. Direkt, freundlich, sendefertig. \
            Keine Anrede ergänzen, keine Signatur, keine Bulletpoints.
            """
        case .mail:
            return """
